...
public class NotificationService {
    ...
    public List<Notification> getUserNotifications(Long userId) {
        return notificationRepository.findAllByRecipient_IdAndIsReadFalseOrderByTimeStampDesc(userId);
    }
    ...
    public ResponseEntity<List<Notification>> markAllNotificationsAsRead(Long userId) {
        var notifications = notificationRepository.findAllByRecipient_IdAndIsReadFalseOrderByTimeStampDesc(userId);
